...
The syntax is a lambda expression with only one side stressed. The right-hand side is the expression to evaluate only for its side effect, and the left-hand side can be missing or a name enclosed within `()`. 
